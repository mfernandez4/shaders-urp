...
/// <summary>
/// Represents a noise generator that produces 3-dimensional Simplex Perlin noise.
/// This algorithm has a computational cost of O(n+1) where n is the dimension.
/// The noise module outputs values that usually range from -1.0 to +1.0, but there are no guarantees that all output values will exist within that range.
/// </summary>
/// <remarks>
/// This class is based on the example code from the paper by Stefan Gustavson, Linköping University, Sweden.
/// Some changes were made by Sebastian Lague for use in a tutorial series.
/// </remarks>
public class Noise
{
    #region Values
